...
const DogParkCard = (props) => {
  const { id, title, description, price, created_at, updated_at, imgURL } =
    props.value;
  return (
    <div className="w-96 rounded overflow-hidden shadow-lg">
      <img
        ...
        src={imgURL?imgURL:
          "https://media.istockphoto.com/id/1389600745/photo/rottweiler-dog-and-alaskan-malamute-in-the-park.jpg?s=1024x1024&w=is&k=20&c=HTcc1kw4s-i3Nik60S02pSJzmdvAQEwQeuLfS9PwD6I="
        }
